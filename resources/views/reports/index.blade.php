        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card card-custom stat-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-0">{{ $stats['total_participants'] ?? 0 }}</h2>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card card-custom bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-0">{{ $stats['total_attendance'] ?? 0 }}</h2>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card card-custom bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-0">{{ $stats['today_attendance'] ?? 0 }}</h2>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card card-custom bg-warning text-dark">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-0">{{ $stats['avg_daily_attendance'] ?? 0 }}</h2>
                ...
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        ...
                        <div class="d-flex justify-content-between mb-2">
                            ...
                            <span>{{ $magangCount }} ({{ $magangPercent }}%)</span>
                        </div>
                        <div class="d-flex justify-content-between">
                            <span class="badge bg-info">PKL</span>
                            <span>{{ $pklCount }} ({{ $pklPercent }}%)</span>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="col-12">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        <div class="col-md-3">
                            <a href="{{ route('reports.attendance') }}" class="card card-custom text-decoration-none h-100">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('reports.participants') }}" class="card card-custom text-decoration-none h-100">
                                <div class="card-body text-center">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('reports.export.attendance') }}" class="card card-custom text-decoration-none h-100">
                                <div class="card-body text-center">
                        ...
                        <div class="col-md-3">
                            <a href="{{ route('reports.export.participants') }}" class="card card-custom text-decoration-none h-100">
                                <div class="card-body text-center">
