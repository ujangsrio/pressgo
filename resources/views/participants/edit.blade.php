        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Edit data peserta {{ $participant->name }}</p>
                </div>
        ...
        <div class="col-lg-9">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('participants.update', $participant->id) }}" method="POST" enctype="multipart/form-data" id="participantForm">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" 
                                       ...
                                       value="{{ old('tanggal_bergabung', $participant->tanggal_bergabung) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('program_type') is-invalid @enderror" 
                                    ...
                                    <option value="Magang" {{ old('program_type', $participant->program_type) == 'Magang' ? 'selected' : '' }}>Magang</option>
                                    <option value="PKL" {{ old('program_type', $participant->program_type) == 'PKL' ? 'selected' : '' }}>PKL</option>
                                    <option value="Studi Independen" {{ old('program_type', $participant->program_type) == 'Studi Independen' ? 'selected' : '' }}>Studi Independen</option>
                                </select>
                                @error('program_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="alert alert-info">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <span class="badge bg-dark">{{ $participant->barcode_id }}</span>
                                        </div>
                                        <div class="col-md-6">
                                            <strong>Username Saat Ini:</strong> 
                                            <span class="badge bg-secondary">{{ $participant->username ?? 'Belum diatur' }}</span>
                                        </div>
                                    </div>
                                    <p class="mb-0 mt-2">
                                        <small>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Apakah Anda yakin ingin menghapus foto peserta <strong>{{ $participant->name }}</strong>?</p>
