            ...
            <div class="id-card-inner">
                ...
                <div class="id-card-front">
                    ...
                    <div class="photo-section">
                        <div class="photo-placeholder">
                            @if($participant->gambar)
                                <img src="{{ $participant->getGambarUrlAttribute() }}" alt="Foto {{ $participant->name }}" class="participant-photo">
                            @else
                    ...
                    <div class="validity-front">
                        VALID THRU {{ date('m/y', strtotime('+12 months')) }}
                    </div>
                </div>
                    ...
                    <div class="barcode-section">
                        <div class="barcode-container">
                            @if($participant->qr_code_url)
                                <img src="{{ $participant->qr_code_url }}" alt="QR Code {{ $participant->barcode_id }}" style="width: 100px; height: 100px;">
                            @else
