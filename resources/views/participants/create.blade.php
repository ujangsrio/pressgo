        ...
        <div class="col-lg-9">
            <div class="card card-custom">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('participants.store') }}" method="POST" enctype="multipart/form-data" id="participantForm">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select @error('program_type') is-invalid @enderror" 
                                    ...
                                    <option value="Magang" {{ old('program_type') == 'Magang' ? 'selected' : '' }}>Magang</option>
                                    <option value="PKL" {{ old('program_type') == 'PKL' ? 'selected' : '' }}>PKL</option>
                                </select>
                                @error('program_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
