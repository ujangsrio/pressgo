                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4 mb-2">
                            <a href="<?php echo e(route('participant.attendance.scan')); ?>" class="btn btn-primary w-100">
                                <i class="fas fa-qrcode me-2"></i>Scan Absensi
                            </a>
                        </div>
                        <div class="col-md-4 mb-2">
                            <a href="<?php echo e(route('participant.attendance.index')); ?>" class="btn btn-success w-100">
                ...
                <div class="card-body">
                    ...
                    <table class="table table-sm table-borderless">
                        ...
                        <tr>
                            ...
                            <td><?php echo e(auth()->guard('participant')->user()->department ?? '-'); ?></td>
                        </tr>
                        <tr>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASVS\Desktop\lisa-absensi\absensi-digital\resources\views\participant\dashboard.blade.php ENDPATH**/ ?>