...
<body>
    <div class="action-buttons">
        ...
        <a href="<?php echo e(route('participants.index')); ?>" class="btn" style="background: #6c757d;">
            ...
            <div class="id-card-side id-card-front">
                ...
                <div class="barcode-section">
                    <div class="barcode-container">
                        <svg class="barcode" data-barcode="<?php echo e($participant->barcode_id); ?>"></svg>
                    </div>
...
</html><?php /**PATH C:\Users\ASVS\Desktop\lisa-absensi\absensi-digital\resources\views\participants\id-cards-all.blade.php ENDPATH**/ ?>