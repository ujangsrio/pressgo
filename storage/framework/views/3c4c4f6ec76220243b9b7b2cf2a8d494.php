        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card card-custom bg-success text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-0"><?php echo e($stats['present'] ?? 0); ?></h2>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card card-custom bg-warning text-dark">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-0"><?php echo e($stats['late'] ?? 0); ?></h2>
        ...
        <div class="col-xl-3 col-md-6 mb-4">
            <div class="card card-custom bg-info text-white">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h2 class="fw-bold mb-0"><?php echo e($stats['participants'] ?? 0); ?></h2>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="fw-semibold">
                                        <?php echo e($attendance->participant->nim ?? 'N/A'); ?>
                                ...
                                <td class="text-center">
                                    <div class="btn-group btn-group-sm">
                                        ...
                                        <button class="btn btn-outline-danger" 
                                                onclick="confirmDelete(<?php echo e($attendance->id); ?>, '<?php echo e(($attendance->participant->name ?? 'Peserta Tidak Ditemukan') . ' - ' . \Carbon\Carbon::parse($attendance->date)->format('d/m/Y')); ?>')"
                                                data-bs-toggle="tooltip" 
                                                title="Hapus Absensi"
                                                <?php echo e(!$attendance->participant ? 'disabled' : ''); ?>>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\ASVS\Desktop\lisa-absensi\absensi-digital\resources\views\attendance\index.blade.php ENDPATH**/ ?>