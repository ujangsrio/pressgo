...
<body>
    ...
    <nav id="sidebar">
        ...
        <ul class="list-unstyled components">
            ...
            <li>
                <a href="<?php echo e(route('attendance.index')); ?>" class="<?php echo e(request()->routeIs('attendance.index') ? 'active' : ''); ?>">
                    <i class="bi bi-calendar-check"></i> Data Absensi
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('attendance.scan')); ?>" class="<?php echo e(request()->routeIs('attendance.scan') ? 'active' : ''); ?>">
                    <i class="bi bi-upc-scan"></i> Scan Barcode
                </a>
            </li>
            <li>
                <a href="<?php echo e(route('participants.index')); ?>" class="<?php echo e(request()->routeIs('participants.*') ? 'active' : ''); ?>">
        ...
        <div class="sidebar-footer">
            <div class="d-flex align-items-center">
                <div class="user-avatar me-3"><?php echo e(substr(session('admin_name'), 0, 1)); ?></div>
                <div class="user-info">
                    <small class="d-block text-white"><?php echo e(session('admin_name')); ?></small>
                ...
                <div class="navbar-nav ms-auto">
                    <div class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex align-items-center" href="#" role="button" data-bs-toggle="dropdown">
                            <div class="user-avatar me-2"><?php echo e(substr(session('admin_name'), 0, 1)); ?></div>
...
<?php /**PATH C:\Users\ASVS\Desktop\lisa-absensi\absensi-digital\resources\views\layouts\sidebar.blade.php ENDPATH**/ ?>